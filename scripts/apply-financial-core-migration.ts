/**
 * Apply Financial Core migration.
 * Run: NODE_OPTIONS=--use-system-ca npx tsx scripts/apply-financial-core-migration.ts
 */
...
const MIGRATION = "supabase/migrations/20260712000007_financial_core.sql";
...
async function main() {
  ...
  console.log("=== Apply Financial Core migration ===");
