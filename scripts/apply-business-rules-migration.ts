/**
 * Apply Business Rules Engine migration (wallets, payment methods, crew earnings).
 * Run: NODE_OPTIONS=--use-system-ca npx tsx scripts/apply-business-rules-migration.ts
 */
...
const MIGRATION =
  "supabase/migrations/20260712000006_business_rules_engine.sql";
...
async function main() {
  ...
  console.log("=== Apply Business Rules migration ===");
