/**
 * Apply profiles Connect-peers RLS recursion hotfix.
 * Run: npx tsx scripts/apply-profiles-connect-peers-rls-fix.ts
 */
...
async function main() {
  ...
  console.log("=== Apply profiles Connect-peers RLS hotfix ===");
