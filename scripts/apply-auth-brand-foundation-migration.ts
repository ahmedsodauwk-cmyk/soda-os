/**
 * Apply Auth & Brand Identity foundation migration.
 * Run: npx tsx scripts/apply-auth-brand-foundation-migration.ts
 *
...
const MIGRATION =
  "supabase/migrations/20260713000012_auth_brand_foundation.sql";
...
async function main() {
  ...
  console.log("=== Apply Auth / Brand Identity foundation migration ===");
  ...
  console.log("  NOTE: This migration does NOT create Auth users.");
...
`);
  ...
  try {
    ...
    console.log("Auth foundation ready — awaiting Founder crew list for accounts.");
    process.exit(0);
  } catch (err) {
    console.log(
    ...
    console.log(`
Paste ${MIGRATION} in the Dashboard SQL Editor.
`);
    process.exit(1);
  }
}
