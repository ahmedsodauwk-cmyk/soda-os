...
/**
 * Minimal Founder RBAC structure — assign/revoke DB permissions.
 * Does not create users; waits for official crew list for provisioning.
 */
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <p className="text-[11px] font-semibold tracking-[0.14em] text-primary/80 uppercase">
          SODA VISUALS · Permissions
        </p>
        <p className="text-sm text-muted-foreground">
          Database <code className="text-xs">role_permissions</code> is the
          Source of Truth. Customize roles here — no Auth accounts are created
          on this screen.
        </p>
        {pending ? (
