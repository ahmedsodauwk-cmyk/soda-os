...
export const HUMAN_LAYER: Record<HumanLayerKey, string> = {
  ...
  projects:
    "المشاريع تابعة للعميل.\nدي قائمة عبر العملاء — كل مشروع مربوط بعميل واحد.",
  clients:
    "العميل هو مركز الشغل.\nمن هنا تفتح مساحة العميل: شغل يومي، مشاريع، ومالية.",
  ...
  connect: "Team Chat — تواصل الفريق الرسمي جوّه صودا.\nمحادثات خاصة + غرفة الفريق — من غير ضجيج برا.",
  ...
  revenue: "اللي اتجمّع فعليًا — مش السعر المتفق عليه.",
  ...
  revenueThisMonth: "دخل الشهر الحالي من التحصيل الفعلي.",
