...
export const mockProjects: Project[] = [
  ...
  },
  {
    ...
    ordersCount: 1,
    revenue: 22000,
    team: [team.sara, team.omar],
    upcomingShoots: [],
    lastActivity: "2026-03-20T12:00:00Z",
    description: "Cinematic engagement film for Layla Ibrahim.",
    createdAt: "2026-01-18T09:00:00Z",
    updatedAt: "2026-03-20T12:00:00Z",
    isActive: true,
    ...hubDefaults({
      overview: {
        summary: "Engagement coverage at Zamalek Waterfront with aerial shots.",
        milestones: ["Shoot complete", "Edit in progress"],
        nextAction: "Deliver cinematic cut for client review.",
      },
      orders: [
        {
          id: "SODA-2026-0007",
      ...
      timeline: [
        {
          id: "tl-li-1",
          title: "Booked",
          description: "Engagement package confirmed.",
          date: "2026-01-18",
          type: "milestone",
        },
      ],
      ...
      activity: [
        {
          id: "act-li-1",
          actor: "Sara Nabil",
          action: "Started engagement film edit",
  ...
  },
  {
    ...
    description: "Maternity portrait session with partner.",
    createdAt: "2026-01-25T12:00:00Z",
    updatedAt: "2026-04-01T10:00:00Z",
    isActive: true,
    ...hubDefaults({
      overview: {
        summary: "Soft natural-light maternity portraits in Studio A.",
        milestones: ["Session booked"],
        nextAction: "Confirm wardrobe and partner attendance.",
      },
      orders: [
        {
          id: "SODA-2026-0011",
      ...
      timeline: [
        {
          id: "tl-ya-1",
          title: "Booked",
          description: "Maternity session confirmed.",
          date: "2026-01-25",
          type: "milestone",
        },
      ],
      ...
      activity: [
        {
          id: "act-ya-1",
          actor: "Dina Farid",
          action: "Scheduled maternity session",
  ...
  },
  {
    ...
    description: "Cancelled mall campaign — postponed indefinitely.",
    createdAt: "2025-11-28T15:00:00Z",
    updatedAt: "2025-12-10T12:00:00Z",
    isActive: true,
    ...hubDefaults({
      overview: {
        summary: "Commercial social campaign cancelled by client.",
        milestones: ["Deposit received", "Campaign cancelled"],
        nextAction: "Archive unless client rebooks in Q3.",
      },
      orders: [
        {
          id: "SODA-2026-0010",
      ...
      timeline: [
        {
          id: "tl-of-1",
          title: "Cancelled",
          description: "Client postponed campaign indefinitely.",
          date: "2025-12-10",
          type: "ops",
        },
      ],
      ...
      activity: [
        {
          id: "act-of-1",
          actor: "Ahmed Hassan",
          action: "Marked campaign as cancelled",
